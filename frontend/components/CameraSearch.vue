<template>
  <div class="relative">
    ...
    <button
      ...
      aria-label="Traži po slici"
      title="Slikaj proizvod da ga pronađeš"
    >
      ...
      >
        <div class="bg-white dark:bg-gray-800 rounded-xl max-w-lg w-full max-h-[90vh] overflow-hidden shadow-2xl">
          ...
          <div v-if="result && !isLoading" class="p-4 border-t dark:border-gray-700">
            <button
              @click="closeModal"
              class="w-full py-2.5 bg-primary-600 text-white rounded-lg font-medium hover:bg-primary-700 transition-colors"
            >
              Zatvori
            </button>
          </div>
