        ...
        <div class="mb-8 bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            >
              ...
              Korisničke prijave
              <span v-if="stats.pending_submissions > 0" class="ml-2 px-2 py-0.5 rounded-full text-xs bg-orange-200 text-orange-800">
            ...
            >
              ...
              Učitani računi
              <span v-if="stats.pending_receipts > 0" class="ml-2 px-2 py-0.5 rounded-full text-xs bg-amber-200 text-amber-800">
            ...
            >
              ...
              Podrška - Razgovori
              <span v-if="stats.unread_support_messages > 0" class="ml-2 px-2 py-0.5 rounded-full text-xs bg-violet-200 text-violet-800">
                {{ stats.unread_support_messages }}
              </span>
            </NuxtLink>
            ...
            <NuxtLink
              ...
              class="inline-flex items-center px-4 py-2 border border-rose-300 rounded-md shadow-sm text-sm font-medium text-rose-700 bg-rose-50 hover:bg-rose-100"
            >
              <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
